 ...
 *
 * @export
 * @class CSGOPrivateProfileError
 * @extends {Error}
 */
export default class CSGOPrivateProfileError extends Error {
  public constructor(name: string) {
    super();
    this.name = "CSGOPrivateProfileError";
    this.message = `[CSGOPrivateProfile] The username supplied [ ${name} ] has a private steam account.`;
  }
}
